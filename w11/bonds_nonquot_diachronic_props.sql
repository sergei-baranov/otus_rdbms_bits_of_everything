CREATE TABLE bonds.`nonquot_diachronic_props` (
  ...
  `emission_id` INT UNSIGNED NOT NULL COMMENT 'FK: su.emission.id',
  `anchor_date` DATE NOT NULL COMMENT 'Дата, на которую рассчитаны свойства',
...
) /*!50100 TABLESPACE `innodb_file_per_table` */ ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Свойства бумаг, которые зависят от даты, но не зависят от котировок'
/* DATA DIRECTORY = '/mysql_tablespaces/sd1t/bonds' - commented; for home usage */
