CREATE TABLE tsq.`7days` (
  ...
  `indicative_price` DECIMAL(16,10) UNSIGNED DEFAULT NULL 'Индикативная цена, % от номинала',
  `indicative_price_type` VARCHAR(16) DEFAULT NULL 'Тип индикативной цены',
  ...
  `duration` DECIMAL(18,10) UNSIGNED DEFAULT NULL COMMENT 'Индикативная дюрация, в днях',
